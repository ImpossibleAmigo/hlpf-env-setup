...
export class CreateTables1700000001000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_ff568519ca47f630606334544d6') THEN ALTER TABLE "product" ADD CONSTRAINT "FK_ff568519ca47f630606334544d6" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE SET NULL ON UPDATE NO ACTION; END IF; END $$;`);
    }
